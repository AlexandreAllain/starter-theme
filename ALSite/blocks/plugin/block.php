 ...
 * Description: Un plugin pour ajouter des blocs personnalisés à Gutenberg.
 */
                ...
                'location' => array(
                    array(
                        array(
                            'param' => 'block',
                            'operator' => '==',
                            'value' => 'acf/plugin', // Remplacez 'acf/plugin' par la valeur du champ 'name' de votre bloc personnalisé
                        ),
                    ),
                ),
                'menu_order' => 0,
